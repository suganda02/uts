...
public class Soal2-2 {
    public static void main(String[] args) throws Exception{
        ArrayList<soal1> zakatList = new ArrayList<>();
        ...
        do {
            ...
            if (jenisZakat.equalsIgnoreCase("fitrah")) {
                ...
                soal1 zakatFitri = new soal1(nama, alamat, jenisZakat, jumlahBeras, jumlahZakat);
                zakatList.add(zakatFitri);
            } else if (jenisZakat.equalsIgnoreCase("sedekah")) {
                double jumlahZakat = jumlahUang;

                soal1 zakatFitri = new soal1(nama, alamat, jenisZakat, jumlahUang, jumlahZakat);
                zakatList.add(zakatFitri);
            }
